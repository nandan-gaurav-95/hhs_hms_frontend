...
function LoginHHSComplex() {
  const [passwordVisible, setPasswordVisible] = useState(false);
  const [passwordError, setPasswordError] = useState("");
  const [department, setDepartment] = useState("HHS Complex");
  ...
  const handleLogin = async () => {
    ...
    navigate("/homehhscomplex"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtextprop">HHS Complex Department </p>
...
export default LoginHHSComplex;
