...
function LoginInventory() {
  ...
  const [department, setDepartment] = useState("Inventory");
  ...
  const handleLogin = async () => {
    ...
    navigate("/homeinventory"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtext">Login In to Inventory Management</p>
