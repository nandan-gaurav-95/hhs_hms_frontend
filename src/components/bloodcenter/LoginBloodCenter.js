...
function LoginBloodCenter() {
  ...
  const handleLogin = async () => {
    ...
    navigate("/homebloodcenter"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtextprop">Blood Center Department</p>
...
export default LoginBloodCenter;
