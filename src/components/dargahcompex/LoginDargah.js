...
function LoginDargah() {
  const [passwordVisible, setPasswordVisible] = useState(false);
  const [passwordError, setPasswordError] = useState("");
  const [department, setDepartment] = useState("Dargah Complex");
  ...
  const handleLogin = async () => {
    ...
    navigate("/homedargah"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtextprop">Dargah Complex Department</p>
