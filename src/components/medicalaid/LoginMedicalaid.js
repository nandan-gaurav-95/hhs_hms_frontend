...
function LoginMedicalaid() {
  ...
  const [department, setDepartment] = useState("Medical Aid");
  ...
  const handleLogin = async () => {
    ...
    navigate("/homemedicalaid"); // Redirect to the desired page after successful login
    //   } else {
...
export default LoginMedicalaid;