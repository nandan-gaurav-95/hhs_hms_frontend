...
function LoginTapal() {
  ...
  const [department, setDepartment] = useState("Tapal");
  ...
  const handleLogin = async () => {
    ...
    navigate("/hometapal"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtextprop">Tapal Department</p>
