...
function LoginGirlsHostel() {
  ...
  const handleLogin = async () => {
    ...
    navigate("/homegirlshostel"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv ">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtext">Login In to Girls Hostel</p>
...
export default LoginGirlsHostel;
