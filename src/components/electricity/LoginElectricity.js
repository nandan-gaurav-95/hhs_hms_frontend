...
function LoginElectricity() {
  ...
  const handleLogin = async () => {
    ...
    navigate("/homeelectricity"); // Redirect to the desired page after successful login
    //   } else {
      ...
      <Container fluid className="loginBOdyDiv">
        ...
        <Col className="forbusiness-page">
          <div className="subforbusiness-page">
            ...
            <p className="subloginformtextprop">Electricity Department</p>
...
export default LoginElectricity;
